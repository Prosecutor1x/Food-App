      ...
      <View style={styles.bod}>
        <View style={{borderBottomWidth: 1, paddingVertical: 5}}>
          ...
          <Text style={styles.price}>
            {' '}
            Delivery Fee : Rs {order.Restaurant.deliveryFee}
          </Text>
          <Text style={{marginHorizontal: 5, marginVertical: 5, color: 'grey'}}>
            {order.status} : 30 mins ago
          </Text>
          <Text style={styles.timeAndDistance}>
            Expected delivery between {order.Restaurant.minDeliveryTime} -{' '}
            {order.Restaurant.maxDeliveryTime} minutes
          </Text>
        </View>
